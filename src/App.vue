<template>
  <div id="app">
    ...
    <div id="container">
      ...
      <div id="community">
          <img id="communityBackground" alt="" src=""/>
        <CommunityNews/>
      </div>
      <Digitark/>
    </div>
...
<style>
  ...
  @media only screen and (min-width: 600px){
    ...
    #communityBackground{
      background: url("https://res.cloudinary.com/telia/image/upload/f_auto,fl_lossy,q_auto:best/era/avaleht/full_bg.png");
     background-size: 100%;
      width: 100%;
      height: 520px;
      z-index: -1;
